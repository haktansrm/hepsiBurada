package org.hepsiburada.Utils.listeners;

import com.aventstack.extentreports.ExtentReports;
import com.aventstack.extentreports.Status;
import org.hepsiburada.Pages.BasePage;
import org.hepsiburada.Utils.reports.ExtentManager;
    ...
    public void onTestFailure(ITestResult result) {
        try {
            ...
            ExtentTestManager.getTest()
                    .fail("<span class='label end-time'>Screenshot of the error</span><a href='"
                            + thumbnailPath +
                            "' data-featherlight='image'> <img style='width:150px;height:100px;display:block;margin-top:5px' src='"
                            + thumbnailPath +
                            "'> </a>");
