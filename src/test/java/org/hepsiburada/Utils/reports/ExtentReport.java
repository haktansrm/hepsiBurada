package org.hepsiburada.Utils.reports;
...
public class ExtentReport implements IReporter {
    ...
    private String reportFileName = "emailreport.html";
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
        ...
        //Mailer.send("Fizy Test Report", ExtentManager.reportName);
    }
    ...
    protected void generateMethodSummaryReport(List<ISuite> suites) {
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r2 : r.values()) {
                ...
                resultSummary(suite, testContext.getSkippedTests(), testName, "ignored", "");
                testIndex++;
            }
        }
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println(".passedodd td {background-color: #248053}");
        out.println(".passedeven td {background-color: #AEDFC7}");
        out.println(".skippedodd td {background-color: #CCC}");
        out.println(".skippedodd td {background-color: #DDD}");
        out.println(".failedodd td,.numi_attn {background-color: #F33}");
        out.println(".failedeven td,.stripe .numi_attn {background-color: #D00}");
        out.println(".stacktrace {white-space:pre;font-family:monospace}");
        out.println("h1 {font-size: 24px !important}");
        out.println("h2 {font-size: 18px !important}");
        out.println("</style>");
        out.println("</head>");
        out.println("<body>");
    }
